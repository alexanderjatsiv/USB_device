...
//
//*****************************************************************************
#define KEYB_IN_REPORT_SIZE 64
#define KEYB_OUT_REPORT_SIZE 64
...
typedef struct
{
    ...
    //
    //TODO: Resize buffers for our, purpose
...
extern uint32_t USBDHIDKeyboardKeyStateChange(void *pvKeyboardInstance,
                                              ...
                                              bool bPressed);
                                              */
extern uint32_t USBDHIDGenericChange(void *pvKeyboardDevice);
