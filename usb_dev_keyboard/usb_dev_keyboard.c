...
#include "examples/boards/ek-tm4c1294xl/drivers/buttons.h"
                ...
                void *pvMsgData)
{
    switch (ui32Event)
    {
        ...
        //
        //TODO: Not needed, this was used to recieve caps lock key info
        //      We will need some kind of even handler for incoming data
...
SendReport()
{
    ...
    if(USBDHIDGenericChange((void *)&g_sKeyboardDevice) != KEYB_SUCCESS)
    {
        return;
    }
}
...
//
//*****************************************************************************
//TODO: Rewrite to send output report data
void
...
main(void)
{
    ...
    while(1)
    {
        ...
        while(g_bConnected)
        {
            ...
            // the buttons again.
            //
            while(g_ui32SysTickCount <= ui32LastTickCount + 4  )
            {
            }
        }
    }
